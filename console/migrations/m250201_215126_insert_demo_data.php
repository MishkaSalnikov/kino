...
class m250201_215126_insert_demo_data extends Migration //демо данные в каталог фильмов и несколько сеансов.
{
    ...
    public function safeUp()
    {
        // Демо-фильмы
        $demoFilms = [
            ['Интерстеллар', 'Фантастический фильм про космос', 169, 12, ''],
            ['Матрица', 'Культовый фильм про виртуальную реальность', 136, 16, ''],
            ['Властелин колец', 'Фэнтези про Кольцо Всевластия', 178, 12, ''],
        ];
